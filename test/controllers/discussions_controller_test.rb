...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { description: @discussion.description, name: @discussion.name, picture: @discussion.picture } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { description: @discussion.description, name: @discussion.name, picture: @discussion.picture } }
